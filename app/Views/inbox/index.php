    ...
    $(document).ready(function() {
        ...
        $('#addModal').on('show.bs.modal', function (e) {
            ...
            if (triggerElement) {
                ...
                newForm.innerHTML += '<div class="mb-3 align-items-center"><input type="hidden" name="jns_byr" class="form-control" id="jns_byr" value="' + itemData.jns_byr + '"></div>';
                // is_vendor
                ...
                $.get('<?= base_url('order/detail-order') ?>/' + idOrder, function(data) {
                    ...
                    console.log(itemData.stat, 'itemData.stat');
                    console.log(itemData.jns_order, 'itemData.jns_order');
                    if((is_vendor == '1' && ['1','4','5'].includes(itemData.stat)) || (is_pemesan == '1' && ['1', '4','5'].includes(itemData.stat))){
                        // form driver
